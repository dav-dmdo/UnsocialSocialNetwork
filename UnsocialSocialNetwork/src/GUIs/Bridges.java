...
static GraphM graph;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Here you will be able to see which users are bridges between isles");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/download.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bridges.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
